 ...
 * Shared between the site's Location section and the /infopult kiosk board.
 */
export function PropertyMapSvg({ titleId, title, className }: { titleId: string; title: string; className?: string }) {
  return (
    <svg viewBox="0 0 340 300" className={className ?? "block w-full"} role="img" aria-labelledby={titleId}>
      ...
      <path d="M 178,110 C 145,98 105,92 55,86" fill="none" stroke="#DDD7C8" strokeWidth={9} strokeLinecap="round" />
