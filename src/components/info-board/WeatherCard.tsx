        ...
        {weather ? (
          <>
            <div className="flex items-center gap-3">
              <Icon size={40} className="shrink-0 text-olive-dark" strokeWidth={1.6} />
              <span className="text-[clamp(2.25rem,5vw,3.25rem)] font-bold leading-none tracking-tight text-ink">
