export const sr = {
  ...
  gallery: {
    ...
    subtitle: "Placeholder fotografije — biće zamenjene pravim snimcima smeštaja.",
    categories: {
      bedrooms: "Spavaonice",
    ...
    captions: {
      "bedrooms.img1": "Spavaonica sa individualnim krevetima i zavesama za privatnost",
      "bedrooms.img2": "Lични ormarić i polica pored svakog kreveta",
      "kitchen.img1": "Zajednička kuhinja sa osnovnim aparatima",
      "kitchen.img2": "Trpezarijski sto za zajedničke obroke",
      "bathroom.img1": "Kupatilo održavano u urednom stanju",
      "storage.img1": "Ostava za veće lične stvari",
      "details.img1": "Topli, prirodni tonovi enterijera",
      "details.img2": "Detalji u boji drveta i tekstila",
    },
...
export const en: Dictionary = {
  ...
  gallery: {
    ...
    subtitle: "Placeholder photos — will be replaced with real photos of the residence.",
    categories: {
      bedrooms: "Bedrooms",
    ...
    captions: {
      "bedrooms.img1": "Bedroom with individual beds and privacy curtains",
      "bedrooms.img2": "Personal locker and shelf next to each bed",
      "kitchen.img1": "Shared kitchen with basic appliances",
      "kitchen.img2": "Dining table for shared meals",
      "bathroom.img1": "Bathroom kept in tidy condition",
      "storage.img1": "Storage room for larger personal items",
      "details.img1": "Warm, natural interior tones",
      "details.img2": "Wood-tone and textile details",
    },
