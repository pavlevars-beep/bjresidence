export const sr = {
  ...
  gallery: {
    ...
    captions: {
      "exterior.img1": "Ulaz u BJ Residence",
      ...
      "kitchen.img1": "Trpezarija i kuhinjski pult sa sudoperom",
      "kitchen.img2": "Trpezarijski sto za zajedničke obroke",
      "bathroom.img1": "Kupatilo sa tušem, veš-mašinom i bojlerom",
      "details.img1": "Uređen ulazni hodnik",
      "details.img2": "Hodnik sa privatnim spavaćim kabinama",
    },
  ...
  personalUnit: {
    ...
    features: [
      "Sopstveni krevet od punog drveta sa premium dušekom",
      "Zavesa za potpunu privatnost",
      "Lampa za čitanje",
      "Utičnice uz krevet",
      "Noćni stočić",
      "Velike fioke za odlaganje",
    ],
  },
  included: {
    ...
    groups: [
      {
        title: "Privatna kabina",
        description: "Potpuna privatnost, sopstveni prostor za odlaganje, noćni stočić, rasveta i utičnice.",
      },
      {
        title: "Opremljena kuhinja",
        description: "Posuđe, frižider i indukciona ploča za svakodnevnu pripremu hrane.",
      },
      {
        title: "Opremljeno kupatilo",
        description: "Sa veš mašinom za redovno pranje veša.",
      },
      {
        title: "Prostor za odlaganje obuće",
        description: "Uredan ulazni prostor za cipele i spoljnu odeću.",
      },
      {
        title: "Dnevni boravak",
        description: "Udobna garnitura i Smart TV za opuštanje.",
      },
      {
        title: "Spoljni prostor",
        description: "Bašta za odmor na svežem vazduhu.",
      },
    ],
    extrasLabel: "Dodatne pogodnosti",
    extras: [
      "Struja, voda i grejanje uključeni",
      "Prečišćivač vazduha",
      "Brzi Wi-Fi internet",
      "Netflix i SkyShowtime",
      "Promena posteljine na svake dve nedelje",
      "Redovno čišćenje zajedničkih prostorija",
    ],
    positioning: "Za ljude koji žele da žive racionalno, bez odricanja od mira i privatnosti.",
...
export const en: Dictionary = {
  ...
  gallery: {
    ...
    captions: {
      "exterior.img1": "The entrance to BJ Residence",
      ...
      "kitchen.img1": "Dining area and kitchen counter with sink",
      "kitchen.img2": "Dining table for shared meals",
      "bathroom.img1": "Bathroom with shower, washing machine and water heater",
      "details.img1": "Tidy entrance hallway",
      "details.img2": "Corridor with private sleeping cabins",
    },
  ...
  personalUnit: {
    ...
    features: [
      "Solid wood bed with a premium mattress",
      "Curtain for complete privacy",
      "Reading lamp",
      "Outlets by the bed",
      "Nightstand",
  ...
  included: {
    ...
    groups: [
      {
        title: "Private cabin",
        description: "Complete privacy, your own storage space, a nightstand, lighting and outlets.",
      },
      {
        title: "Equipped kitchen",
        description: "Dishware, refrigerator and induction hob for everyday cooking.",
      },
      {
        title: "Equipped bathroom",
        description: "With a washing machine for regular laundry.",
      },
      {
        title: "Shoe storage",
        description: "A tidy entryway space for shoes and outerwear.",
      },
      {
        title: "Living room",
        description: "Comfortable sofa and a Smart TV to unwind.",
      },
      {
        title: "Outdoor space",
        description: "A garden for fresh-air relaxation.",
      },
    ],
    extrasLabel: "Additional amenities",
    extras: [
      "Electricity, water and heating included",
      "Air purifier",
      "Fast Wi-Fi internet",
      "Netflix and SkyShowtime",
      "Bedding changed every two weeks",
      "Regular cleaning of shared areas",
    ],
    positioning: "For people who want to live rationally, without giving up peace and privacy.",
